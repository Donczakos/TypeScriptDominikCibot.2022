...
})({"eVEYj":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "391f2a7672c40a9f";
...
},{}],"9HST7":[function(require,module,exports) {
var _config = require("./config");
var _notes = require("./notes");
new (0, _notes.Notes)((0, _config.DATA));

},{"./config":"71dXz","./notes":"9RoU5"}],"71dXz":[function(require,module,exports) {
...
},{}],"9RoU5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Notes", ()=>Notes);
var _note = require("./note");
var _appStorage = require("./appStorage");
var _appFiresoreStorage = require("./appFiresoreStorage");
class Notes {
    _arrNotes = [];
    ...
    addNotes(localData) {
        if (localData === "localStorage") JSON.parse(localStorage.getItem("Notes")).length > 0 && (this._arrNotes = JSON.parse(localStorage.getItem("Notes")));
        document.querySelector(".addButton")?.addEventListener("click", (event)=>{
            ...
            this._arrNotes.push(new (0, _note.Note)(this._arrNotes.length, title, contents, color, important));
    ...
    addData(localData) {
        ...
        if (localData === "localStorage") new (0, _appStorage.appStorage)(this._arrNotes);
        else new (0, _appFiresoreStorage.appFiresoreStorage)(this._arrNotes);
    }
}

},{"./note":"FIifP","./appStorage":"4n6Ss","./appFiresoreStorage":"6iwvc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"FIifP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Note {
    ...
    _date = 0;
    _done = false;
    constructor(id, title, contents, color, important){
        this._id = id;
        this._title = title;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4n6Ss":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "appStorage", ()=>appStorage);
class appStorage {
    _arrNotes = [];
    _arrNotesString = [];
    _arrNotesStringDone = [];
    constructor(arrNotes){
    ...
    isDone() {
        ...
        buttonDelete?.forEach((e, key)=>{
            e?.addEventListener("click", (event)=>{
                const indexTask = this._arrNotes.indexOf(arrayNotDone[key]);
    ...
    viewNotes() {
        ...
        const arrNotes = JSON.parse(localStorage.getItem("Notes")); // JSON ??????
        this._arrNotesString = arrNotes.map((note, key)=>{
            return !note["_done"] ? this.sortElement(note["_id"], note["_color"], note["_contents"], note["_color"], note["_important"], note["_date"]) : "";
        });
        this._arrNotesStringDone = arrNotes.map((note, key)=>{
    ...
    sortElement(key, title, contents, color, important, date, buttonDone = false) {
        const fullDate = new Date(date);
        let result = "";
        if (buttonDone) result = `<div class="listaToDo"><p style="color:${color}">id: ${key + 1} | ${title} | ${contents} | ${fullDate} |  <button style="display:none" class="buttonDone">Zrobione</button></p></div>`;
        else result = `<div class="listaToDo" style="background:${important ? "#ef9595" : "transparent"}">${important ? "WA\u017BNE" : ""}<p style="color:${color}">id: ${key + 1} | ${title} | ${contents} | ${fullDate} | <button class="buttonDone">Zrobione</button></p></div>`;
        return result;
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6iwvc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "appFiresoreStorage", ()=>appFiresoreStorage);
var _app = require("firebase/app");
var _firestore = require("firebase/firestore");
class appFiresoreStorage {
    _arrNotes = [];
    _arrNotesString = [];
    _arrNotesStringDone = [];
    firebaseConfig = {
    ...
    download() {
        (0, _firestore.getDocs)(this.colRef).then((snapshot)=>{
            let store = [];
    ...
    setData(data) {
        (0, _firestore.setDoc)((0, _firestore.doc)(this.getDb, "zad4", "zad4"), {
            "zad4": `${JSON.stringify(this._arrNotes)}`
        });
    }
    init() {
        const app = (0, _app.initializeApp)(this.firebaseConfig);
        const db = (0, _firestore.getFirestore)();
        const colRef = (0, _firestore.collection)(db, "zad4");
        this.getDb = db;
        this.colRef = colRef;
    }
    viewNotes() {
...
},{"firebase/app":"5wGMN","firebase/firestore":"cJafS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5wGMN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _app = require("@firebase/app");
 ...
 */ !function(t445, e = !0) {
    ...
    }, "PUBLIC")), (0, _app.registerVersion)(D, "3.4.12", t445), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
    (0, _app.registerVersion)(D, "3.4.12", "esm2017");
}();
...
},{}]},["eVEYj","9HST7"], "9HST7", "parcelRequirebb0e")

//# sourceMappingURL=index.72c40a9f.js.map
