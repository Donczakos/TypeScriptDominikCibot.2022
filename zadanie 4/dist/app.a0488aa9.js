...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"ts/config.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.DATA = void 0; // export const DATA:string = "localStorage";

exports.DATA = "firestore";
},{}],"ts/note.ts":[function(require,module,exports) {
"use strict";
...
var Note = /*#__PURE__*/function () {
  function Note(id, title, contents, color, important) {
...
exports.Note = Note;
},{}],"ts/appStorage.ts":[function(require,module,exports) {
"use strict";
...
var appStorage = /*#__PURE__*/function () {
  function appStorage(arrNotes) {
    _classCallCheck(this, appStorage);

    this._arrNotes = [];
    this._arrNotesString = [];
    this._arrNotesStringDone = [];
  ...
  _createClass(appStorage, [{
    ...
    value: function isDone() {
      ...
      var buttonDelete = document.querySelectorAll(".buttonDone");

      var arrayNotDone = this._arrNotes.filter(function (e) {
        return e["_done"] === false;
      });

      console.log(arrayNotDone);
      buttonDelete === null || buttonDelete === void 0 ? void 0 : buttonDelete.forEach(function (e, key) {
        e === null || e === void 0 ? void 0 : e.addEventListener("click", function (event) {
          var indexTask = _this._arrNotes.indexOf(arrayNotDone[key]); // this._arrNotes.indexOf(arrayNotDone[key])


          _this._arrNotes[indexTask]["_done"] = true;
          console.log(_this._arrNotes);
    ...
    value: function viewNotes() {
      ...
      var arrNotes = JSON.parse(localStorage.getItem("Notes"));
      this._arrNotesString = arrNotes.map(function (note, key) {
        return !note["_done"] ? _this2.sortElement(note["_id"], note["_color"], note["_contents"], note["_color"], note["_important"], note["_date"]) : "";
      });
      this._arrNotesStringDone = arrNotes.map(function (note, key) {
        return note["_done"] ? _this2.sortElement(note["_id"], note["_color"], note["_contents"], note["_color"], note["_important"], note["_date"], true) : "";
      });
      this.showElement();
      this.isDone();
    }
    ...
    value: function showElement() {
      document.querySelector(".listTask").innerHTML = this._arrNotesString.join("");
      document.querySelector(".listTaskDone").innerHTML = this._arrNotesStringDone.join("");
    }
  }, {
    key: "sortElement",
    value: function sortElement(key, title, contents, color, important, date) {
      var buttonDone = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : false;
      var fullDate = new Date(date);
      var result = "";

      if (buttonDone) {
        result = "<div class=\"listaToDo\"><p style=\"color:".concat(color, "\">id: ").concat(key + 1, " | ").concat(title, " | ").concat(contents, " | ").concat(fullDate, " |  <button style=\"display:none\" class=\"buttonDone\">Zrobione</button></p></div>");
      } else {
        result = "<div class=\"listaToDo\" style=\"background:".concat(important ? '#ef9595' : 'transparent', "\">").concat(important ? 'WAŻNE' : '', "<p style=\"color:").concat(color, "\">id: ").concat(key + 1, " | ").concat(title, " | ").concat(contents, " | ").concat(fullDate, " | <button class=\"buttonDone\">Zrobione</button></p></div>");
      }
...
},{}],"node_modules/@firebase/auth/dist/esm2017/index-69ab4e3a.js":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "updateEmail", {
  enumerable: true,
  get: function () {
    return _index69ab4e3a.ag;
  }
});
Object.defineProperty(exports, "updatePassword", {
  enumerable: true,
  get: function () {
    return _index69ab4e3a.ah;
  }
});
...
Object.defineProperty(exports, "verifyBeforeUpdateEmail", {
  enumerable: true,
  get: function () {
    return _index69ab4e3a.ac;
  }
});
Object.defineProperty(exports, "verifyPasswordResetCode", {
  enumerable: true,
  get: function () {
    return _index69ab4e3a.a4;
  }
});

var _index69ab4e3a = require("./index-69ab4e3a.js");
...
},{"./index-69ab4e3a.js":"node_modules/@firebase/auth/dist/esm2017/index-69ab4e3a.js","@firebase/util":"node_modules/@firebase/util/dist/index.esm2017.js","@firebase/app":"node_modules/@firebase/app/dist/esm/index.esm2017.js","tslib":"node_modules/tslib/tslib.es6.js","@firebase/logger":"node_modules/@firebase/logger/dist/esm/index.esm2017.js","@firebase/component":"node_modules/@firebase/component/dist/esm/index.esm2017.js"}],"node_modules/firebase/auth/dist/index.esm.js":[function(require,module,exports) {
"use strict";
...
},{"@firebase/auth":"node_modules/@firebase/auth/dist/esm2017/index.js"}],"ts/appFiresoreStorage.ts":[function(require,module,exports) {
"use strict";
...
exports.appFiresoreStorage = void 0;
...
var appFiresoreStorage = /*#__PURE__*/function () {
  function appFiresoreStorage() {
    _classCallCheck(this, appFiresoreStorage);

    this.init();
  }

  _createClass(appFiresoreStorage, [{
    key: "init",
    value: function init() {
      var firebaseConfig = {
        apiKey: "AIzaSyCk4L2XeFrz4VAIYGYwLZf5JvQJlcuJSgI",
        authDomain: "dominik-e528a.firebaseapp.com",
        databaseURL: "https://dominik-e528a-default-rtdb.firebaseio.com",
        projectId: "dominik-e528a",
        storageBucket: "dominik-e528a.appspot.com",
        messagingSenderId: "290392488578",
        appId: "1:290392488578:web:91192d73e084b23888d29b",
        measurementId: "G-L8YTM0PV76"
      };
      console.log("ok"); // Initialize Firebase
  ...
  return appFiresoreStorage;
}();

exports.appFiresoreStorage = appFiresoreStorage;
},{"firebase/app":"node_modules/firebase/app/dist/index.esm.js","firebase/analytics":"node_modules/firebase/analytics/dist/index.esm.js","firebase/auth":"node_modules/firebase/auth/dist/index.esm.js"}],"ts/notes.ts":[function(require,module,exports) {
"use strict";
...
var appFiresoreStorage_1 = require("./appFiresoreStorage");

var Notes = /*#__PURE__*/function () {
  // private _arrNotes: Note[] = JSON.parse(localStorage.getItem("Notes") as string).length > 0 ? JSON.parse(localStorage.getItem("Notes") as string) : [];
  function Notes(localData) {
  ...
  _createClass(Notes, [{
    key: "addNotes",
    value: function addNotes(localData) {
      var _this = this;

      var _a;

      if (localData === "localStorage") {
        JSON.parse(localStorage.getItem("Notes")).length > 0 ? this._arrNotes = JSON.parse(localStorage.getItem("Notes")) : []; // users = JSON.parse(localStorage.getItem("users") || "[]");
      } else {// dodanie Firestone
        // new appFiresoreStorage();
      }

      (_a = document.querySelector(".addButton")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function (event) {
        var title = document.querySelector(".title").value;
        var contents = document.querySelector(".contents").value;
        var color = document.querySelector(".color").value;
        var important = document.querySelector(".important").checked;

        _this._arrNotes.push(new note_1.Note(_this._arrNotes.length, title, contents, color, important));

        _this.addData(localData);
    ...
    key: "addData",
    value: function addData(localData) {
      console.log(localData === "localStorage");

      if (localData === "localStorage") {
        new appStorage_1.appStorage(this._arrNotes); // users = JSON.parse(localStorage.getItem("users") || "[]");
      } else {
        // dodanie Firestone
        new appFiresoreStorage_1.appFiresoreStorage();
      }
    }
  }]);
...
exports.Notes = Notes;
},{"./note":"ts/note.ts","./appStorage":"ts/appStorage.ts","./appFiresoreStorage":"ts/appFiresoreStorage.ts"}],"ts/app.ts":[function(require,module,exports) {
"use strict";
...
new notes_1.Notes(config_1.DATA);
},{"./config":"ts/config.ts","./notes":"ts/notes.ts"}],"../../../AppData/Roaming/nvm/v16.0.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../AppData/Roaming/nvm/v16.0.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ts/app.ts"], null)
