...
})({"6Fbzb":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "b01f0e5857c62c85";
...
},{}],"ey8wQ":[function(require,module,exports) {
var _createInputs = require("./CreateInputs");
const app = new (0, _createInputs.CreateInputs)();

},{"./CreateInputs":"i8Yke"}],"i8Yke":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CreateInputs", ()=>CreateInputs);
...
class CreateInputs {
    ...
    clearInput() {
        ...
        elementsClear.forEach((element1, index)=>{
    ...
    buildInputs() {
        ...
        counter?.addEventListener("keydown", (event)=>{
            ...
            new (0, _calculations.Calculations)(this.elementsInput);
            this.render();
        });
    }
    settings_button() {
    ...
    createInputs() {
        for(let index = 0; index < this.elementsInput; index++)this.arrayString.push("<label for=''>Liczba " + (index + 1) + "<input id='obj" + index + "' placeholder='podaj liczb\u0119' type='text'><button id='clearElement'>-</button></label>");
        this.createInputsElement();
        document.querySelector(".app").innerHTML = this.objectHtml;
    }
    createInputsElement() {
...
},{"./Calculations":"97aPN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"97aPN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Calculations {
    ...
    addElement() {
        for(let index = 0; index < this.elementsInput; index++)this.arrayNumber.push(document.querySelector("input#obj" + index).value);
    }
    settingsField() {
...
},{}]},["6Fbzb","ey8wQ"], "ey8wQ", "parcelRequire94c2")

//# sourceMappingURL=index.57c62c85.js.map
